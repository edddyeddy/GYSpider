...
class LiaoningGovSpider(Spider):
    ...
    def _getProjectID(self, pageNum=None) -> list:
        ...
        # url = 'https://www.ln.gov.cn/web/zwgkx/zfwj/szfwj/89275467-{}.shtml'.format(pageNum) # 辽政发
        # url = 'https://www.ln.gov.cn/web/zwgkx/zfwj/lz/index.shtml' # 辽政
        # url = 'https://www.ln.gov.cn/web/zwgkx/zfwj/szfbgtwj/3c92e3a6-{}.shtml'.format(pageNum) # 辽政办发
